...
#import "BeerSelectedDetailViewController.h"
...
- (void)viewDidLoad
{
    DB_info_URLs *info = [[DB_info_URLs alloc] init];
    title = [info titles];
    URL = [info URLs];
...
{
    BeerSelectedDetailViewController *theStory = [self.storyboard instantiateViewControllerWithIdentifier:@"webstory"];
    [self presentViewController:theStory animated:true completion:nil];
